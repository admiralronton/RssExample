...
@implementation RDRSourcesTableViewController
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    NSEntityDescription *entity = [NSEntityDescription
                                   entityForName:@"RssSource" inManagedObjectContext:managedObjectContext];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    RssSource *source = [_fetchedResultsController objectAtIndexPath:indexPath];
...
{
    static NSString *CellIdentifier = @"sourceCellPrototype";
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([[segue identifier] isEqualToString:@"ShowDetails"]) {
        ...
        RDRSourceDetailViewController* detailViewController = [[[segue destinationViewController] viewControllers] objectAtIndex:0];
        NSIndexPath* indexPath = [self.tableView indexPathForSelectedRow];
        
        // Set the source item for the destination controller
        detailViewController.sourceItem = [_fetchedResultsController objectAtIndexPath:indexPath];
    }
}
