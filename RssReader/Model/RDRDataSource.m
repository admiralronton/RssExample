...
static RDRDataSource *_sharedInstance;


#pragma mark - Class Definition

@implementation RDRDataSource
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"EmptyAppExample01.sqlite"];
...
+ (void)initialize
{
	...
	{
		_sharedInstance = [[RDRDataSource alloc] 
			init];
...
// Saves context to the data store
- (void)saveContext
{
    NSError *error = nil;
...
- (NSArray *)getAllSources
{
    ...
    [fetch setEntity:[NSEntityDescription entityForName:@"RssSource" inManagedObjectContext:self.managedObjectContext]];
