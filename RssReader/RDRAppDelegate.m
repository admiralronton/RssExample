//
//  com_cranestylelabsAppDelegate.m
//  EmptyAppExample01
//
//  Created by Randall Nickerson on 2/26/14.
...
{
    return [[RDRDataSource sharedInstance] managedObjectModel];
}
...
{
    return [[RDRDataSource sharedInstance] persistentStoreCoordinator];
}
